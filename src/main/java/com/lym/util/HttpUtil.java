...
public class HttpUtil {
	 ...
	 * 
	 */
	public static void sendGetAndSaveFile(String urlParam,
			Map<String, Object> params, String fileSavePath) {
		// 构建请求参数
		StringBuffer sbParams = new StringBuffer();
		if (params != null && params.size() > 0) {
	 ...
	 * 
	 */
	public static String sendGet2(String urlParam, Map<String, Object> params,
			String charset) {
		StringBuffer resultBuffer = null;
		// 构建请求参数
		StringBuffer sbParams = new StringBuffer();
     ...
     * 
     */
	public static String httpClientPut(String url, Map<String, Object> params) {
		// 1. 判断传递进来的url连接地是否为空
		if (null == url) {
			return null;
		}
		...
		if (sbParams != null && sbParams.length() > 0) {
			url = url + "?" + sbParams.substring(0, sbParams.length() - 1);
		}
	 ...
	 * 
	 */
	public static String sendSocketPost(String urlParam,
			Map<String, Object> params, String charset) {
		String result = "";
		// 构建请求参数
		StringBuffer sbParams = new StringBuffer();
	 ...
	 * 
	 */
	public static String sendSocketGet(String urlParam,
			Map<String, Object> params, String charset) {
		String result = "";
		// 构建请求参数
		StringBuffer sbParams = new StringBuffer();
